const CACHE='dogson-free-v1686';
const UI_VERSION='1686';
...
function transformHtml(html){
  if(!html.includes('dogson-boot-v1686')){
...
self.addEventListener('install',event=>{
  ...
  event.waitUntil((async()=>{
    ...
    await cache.addAll([
      ...
      './hourly.js?v=1530',
      './realtime-config.js?v=1686',
      './realtime.js?v=1686',
      './ui-filters.js?v=1686',
      './redesign-v160.css?v=1686',
      './redesign-v160-dark.css?v=1686',
      './contrast-v160.css?v=1686',
      './redesign-v162.css?v=1686',
      './redesign-v162-fix.css?v=1686',
      './redesign-v163.css?v=1686',
      './redesign-v164.css?v=1686',
      './redesign-v165.css?v=1686',
      './redesign-v166.css?v=1686',
      './redesign-v1679.css?v=1686',
      './redesign-v1685.css?v=1686',
      './redesign-v1686.css?v=1686',
      './redesign-v160.js?v=1686',
      './ui-polish-v160.js?v=1686',
      './ui-layout-v162.js?v=1686',
      './ui-card-v164.js?v=1686',
      './ui-card-v166.js?v=1686',
      './ui-fold-v167.js?v=1686',
      './ui-entry-v1679.js?v=1686',
      './ui-load-more-v1681.js?v=1686',
      './ui-market-v1685.js?v=1686',
      './ui-market-ticker-v1686.js?v=1686'
    ]);
    try{

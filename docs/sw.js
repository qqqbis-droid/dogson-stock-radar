const CACHE='dogson-free-v1685';
const UI_VERSION='1685';
...
function transformHtml(html){
  if(!html.includes('dogson-boot-v1685')){
...
self.addEventListener('install',event=>{
  ...
  event.waitUntil((async()=>{
    ...
    await cache.addAll([
      ...
      './hourly.js?v=1530',
      './realtime-config.js?v=1685',
      './realtime.js?v=1685',
      './ui-filters.js?v=1685',
      './redesign-v160.css?v=1685',
      './redesign-v160-dark.css?v=1685',
      './contrast-v160.css?v=1685',
      './redesign-v162.css?v=1685',
      './redesign-v162-fix.css?v=1685',
      './redesign-v163.css?v=1685',
      './redesign-v164.css?v=1685',
      './redesign-v165.css?v=1685',
      './redesign-v166.css?v=1685',
      './redesign-v1679.css?v=1685',
      './redesign-v1685.css?v=1685',
      './redesign-v160.js?v=1685',
      './ui-polish-v160.js?v=1685',
      './ui-layout-v162.js?v=1685',
      './ui-card-v164.js?v=1685',
      './ui-card-v166.js?v=1685',
      './ui-fold-v167.js?v=1685',
      './ui-entry-v1679.js?v=1685',
      './ui-load-more-v1681.js?v=1685',
      './ui-market-v1685.js?v=1685'
    ]);
    try{
